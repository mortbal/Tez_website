...
export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    ...
    h1: ({ children, ...props }) => (
      <h1 className="text-4xl font-bold mb-6 text-white border-b border-gray-700 pb-2" {...props}>
        {children}
      </h1>
    ),
    h2: ({ children, ...props }) => (
    ...
    td: ({ children, ...props }) => (
      <td className="border-b border-gray-700 px-4 py-2 text-gray-300" {...props}>
        {children}
      </td>
    ),
